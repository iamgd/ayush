...
if (isset($_POST['username'])) {
    ...
    if ($count_username > 0) {
        ...
        // Insert the members
        $query = mysqli_query($conn, "INSERT INTO members (Username, Email, contactno, Registration_no, Password, Category) VALUES ('$username', '$email', '$contact', '$regno', '$password', '$category')") or die("Could not insert your information");
...
<body>
    ...
    <img style="margin-top:25px;" src="./images/moaemblem.jpg" width="230" height="80" alt="AYUSH">
</div>
    ...
    const cpassword = document.getElementById('cpassword'); // Add cpassword input field
    const category = document.querySelector('input[name="category"]:checked'); // Get the selected category
