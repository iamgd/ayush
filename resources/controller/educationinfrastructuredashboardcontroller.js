var educationinfrastructuredashboardcontroller = moadashboardapp.controller('educationinfrastructuredashboardcontroller', function($scope, $http, commondata, $rootScope) {

    $scope.heading = "Education Infrastructure";
