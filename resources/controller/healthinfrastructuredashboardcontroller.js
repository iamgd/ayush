var healthinfrastructurecontroller = moadashboardapp.controller('healthinfrastructuredashboardcontroller', function($scope, $http, commondata, $rootScope) {

    $scope.heading = "Health Infrastructure";
