var yogaandidydashboardcontroller = moadashboardapp.controller('yogaandidydashboardcontroller', function($scope, $http, commondata, $rootScope) {

    $scope.heading = "Yoga & IDY";
