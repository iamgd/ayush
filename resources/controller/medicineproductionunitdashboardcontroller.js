var medicineproductionunitdashboardcontroller = moadashboardapp.controller('medicineproductionunitdashboardcontroller', function($scope, $http, commondata, $rootScope) {

    $scope.heading = "Medicine Production Unit";
