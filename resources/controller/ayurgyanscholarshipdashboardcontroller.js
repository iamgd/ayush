var ayurgyanscholarshipdashboardcontroller = moadashboardapp.controller('ayurgyanscholarshipdashboardcontroller', function($scope, $http, commondata, $rootScope) {

    $scope.heading = "Ayurgyan Scholarship";
    ...
    var parameter1 = {
        method: 'POST',
        url: 'ayurgyanperformanceindicatorservlet',
        'Content-Type': 'application/json;charset=utf-8',
        data: data1
    };
    $http(parameter1).then(function(response) {
        ...
        var ctx = document.getElementById("ayurgyanscholarship_target_achievement");
        ctx.height = 200;
        new Chart(ctx, {
            type: 'bar',
            data: {
