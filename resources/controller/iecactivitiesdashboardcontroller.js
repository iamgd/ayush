var iecactivitiesdashboardcontroller = moadashboardapp.controller('iecactivitiesdashboardcontroller', function($scope, $http, commondata, $rootScope) {

    $scope.heading = "Information Education & Communication";
    ...
    var parameter = {
        method: 'POST',
        url: 'yearlynoofactivitiesservlet',
    ...
    $http(parameter).then(function(response) {
        ...
        new Chart("iec_progress_chart", {
            type: 'line',
            data: {
                labels: xValues,
                datasets: data2.activity_data
            },
            options: {
                legend: {
                    display: true
    ...
    var parameter3 = {
        method: 'POST',
        url: 'iecperformanceindicatorservlet',
        data: data3,
    ...
    $http(parameter3).then(function(response) {
        ...
        var ctx = document.getElementById("iec_target_achievement");
        ctx.height = 200;
        new Chart(ctx, {
            type: 'bar',
            data: {
