...
angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.collapse", "ui.bootstrap.tabindex", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.common", "ui.bootstrap.dateparser", "ui.bootstrap.isClass", "ui.bootstrap.datepicker", "ui.bootstrap.position", "ui.bootstrap.datepickerPopup", "ui.bootstrap.debounce", "ui.bootstrap.multiMap", "ui.bootstrap.dropdown", "ui.bootstrap.stackedMap", "ui.bootstrap.modal", "ui.bootstrap.paging", "ui.bootstrap.pager", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.tpls", ["uib/template/accordion/accordion-group.html", "uib/template/accordion/accordion.html", "uib/template/alert/alert.html", "uib/template/carousel/carousel.html", "uib/template/carousel/slide.html", "uib/template/datepicker/datepicker.html", "uib/template/datepicker/day.html", "uib/template/datepicker/month.html", "uib/template/datepicker/year.html", "uib/template/datepickerPopup/popup.html", "uib/template/modal/window.html", "uib/template/pager/pager.html", "uib/template/pagination/pagination.html", "uib/template/tooltip/tooltip-html-popup.html", "uib/template/tooltip/tooltip-popup.html", "uib/template/tooltip/tooltip-template-popup.html", "uib/template/popover/popover-html.html", "uib/template/popover/popover-template.html", "uib/template/popover/popover.html", "uib/template/progressbar/bar.html", "uib/template/progressbar/progress.html", "uib/template/progressbar/progressbar.html", "uib/template/rating/rating.html", "uib/template/tabs/tab.html", "uib/template/tabs/tabset.html", "uib/template/timepicker/timepicker.html", "uib/template/typeahead/typeahead-match.html", "uib/template/typeahead/typeahead-popup.html"]), angular.module("ui.bootstrap.collapse", []).directive("uibCollapse", ["$animate", "$q", "$parse", "$injector", function(a, b, c, d) {
        ...
        link: function(d, f, g) {
            function h() {
                r = !!("horizontal" in g), r ? (s = {
                    ...
                    height: "0"
                }), d.$eval(g.uibCollapse) || f.addClass("show").addClass("collapse").attr("aria-expanded", !0).attr("aria-hidden", !1).css(s)
            }
            ...
            function j() {
                f.hasClass("collapse") && f.hasClass("show") || b.resolve(n(d)).then(function() {
                    f.removeClass("collapse").addClass("collapsing").attr("aria-expanded", !0).attr("aria-hidden", !1), e ? e(f, {
                        ...
                        to: i(f[0])
                    }).start()["finally"](k) : a.addClass(f, "show", {
                        css: {
                            overflow: "hidden"
                        },
                        to: i(f[0])
            ...
            function l() {
                return f.hasClass("collapse") || f.hasClass("show") ? void b.resolve(p(d)).then(function() {
                    f.css(i(f[0])).removeClass("collapse").addClass("collapsing").attr("aria-expanded", !1).attr("aria-hidden", !0), e ? e(f, {
                        removeClass: "show",
                        to: t
                    }).start()["finally"](m) : a.removeClass(f, "show", {
                        to: t
                    }).then(m)
                }, angular.noop) : m()
            }
    ...
    return {
        ...
        link: function(a, b, c, d) {
            b.addClass("card"), d.addGroup(a), a.openClass = c.openClass || "card-open", a.cardClass = c.cardClass || "card-default", a.$watch("isOpen", function(c) {
    ...
    return {
        ...
        link: function(b, c, d, e) {
            c.addClass("carousel-item"), e.addSlide(b, c), b.$on("$destroy", function() {
                e.removeSlide(b)
...
}]).animation(".carousel-item", ["$animateCss", function(a) {
    function b(a, b, c) {
        a.removeClass(b), c && c()
    }
...
}]), angular.module("ui.bootstrap.common", []), angular.module("ui.bootstrap.dateparser", []).service("uibDateParser", ["$log", "$locale", "dateFilter", "orderByFilter", "filterFilter", function(a, b, c, d, e) {
    function f(a) {
        return e(s, {
            key: a
        }, !0)[0]
    ...
    function g(a) {
        ...
        return angular.forEach(s, function(d) {
            ...
            if (e > -1) {
                ...
                for (var f = e + 1, g = e + d.key.length; f < g; f++) c[f] = "", a[f] = "$";
                a = a.join(""), b.push({
                    index: e,
                    key: d.key,
                    apply: d.apply,
    ...
    b.addClass("uib-datepicker"), c.$set("role", "application"), a.datepickerOptions || (a.datepickerOptions = {}), this.modes = ["day", "month", "year"], ["customClass", "dateDisabled", "datepickerMode", "formatDay", "formatDayHeader", "formatDayTitle", "formatMonth", "formatMonthTitle", "formatYear", "maxDate", "maxMode", "minDate", "minMode", "monthColumns", "showWeeks", "shortcutPropagation", "startingDay", "yearColumns", "yearRows"].forEach(function(b) {
        ...
        b = b || 1, a.datepickerMode === o.maxMode && 1 === b || a.datepickerMode === o.minMode && b === -1 || (m(o.modes[o.modes.indexOf(a.datepickerMode) + b]), a.$emit("uib:datepicker.mode"))
    }, a.keys = {
        13: "enter",
        32: "space",
        33: "pageup",
    ...
    return {
        ...
        offset: function(c, d) {
            ...
            var e = c.getBoundingClientRect(),
                f = {
                    width: Math.round(angular.isNumber(e.width) ? e.width : c.offsetWidth),
                    height: Math.round(angular.isNumber(e.height) ? e.height : c.offsetHeight),
                    top: Math.round(e.top + (b.pageYOffset || a[0].documentElement.scrollTop)),
                    left: Math.round(e.left + (b.pageXOffset || a[0].documentElement.scrollLeft))
                };
            if (d) {
                var g = window.getComputedStyle(c),
                    h = this.parseStyle(g.marginTop) + this.parseStyle(g.marginBottom),
                    i = this.parseStyle(g.marginLeft) + this.parseStyle(g.marginRight);
        ...
        positionElements: function(a, c, d, e, g) {
            ...
            var h = angular.isDefined(c.offsetWidth) ? c.offsetWidth : c.prop("offsetWidth"),
                i = angular.isDefined(c.offsetHeight) ? c.offsetHeight : c.prop("offsetHeight");
            if (g) {
                var j = window.getComputedStyle(c),
                    k = this.parseStyle(j.marginTop) + this.parseStyle(j.marginBottom),
                    l = this.parseStyle(j.marginLeft) + this.parseStyle(j.marginRight);
                i += k, h += l
            }
            ...
            if (d[2]) {
                var o = this.viewportOffset(a, e),
                    ...
                    q = {
                        width: h + Math.round(Math.abs(this.parseStyle(p.marginLeft) + this.parseStyle(p.marginRight))),
                        height: i + Math.round(Math.abs(this.parseStyle(p.marginTop) + this.parseStyle(p.marginBottom)))
                    };
                if (d[0] = "top" === d[0] && q.height > o.top && q.height <= o.bottom ? "bottom" : "bottom" === d[0] && q.height > o.bottom && q.height <= o.top ? "top" : "left" === d[0] && q.width > o.left && q.width <= o.right ? "right" : "right" === d[0] && q.width > o.right && q.width <= o.left ? "left" : d[0], d[1] = "top" === d[1] && q.height - m.height > o.bottom && q.height - m.height <= o.top ? "bottom" : "bottom" === d[1] && q.height - m.height > o.top && q.height - m.height <= o.bottom ? "top" : "left" === d[1] && q.width - m.width > o.right && q.width - m.width <= o.left ? "right" : "right" === d[1] && q.width - m.width > o.left && q.width - m.width <= o.right ? "left" : d[1], "center" === d[1])
                    if (f.vertical.test(d[0])) {
                        var r = m.width / 2 - h / 2;
                        o.left + r < 0 && q.width - m.width <= o.right ? d[1] = "left" : o.right + r < 0 && q.width - m.width <= o.left && (d[1] = "right")
                    } else {
                        var s = m.height / 2 - q.height / 2;
                        o.top + s < 0 && q.height - m.height <= o.bottom ? d[1] = "top" : o.bottom + s < 0 && q.height - m.height <= o.top && (d[1] = "bottom")
                    }
            }
            switch (d[0]) {
                case "top":
            ...
            switch (d[1]) {
                ...
                case "right":
                    ...
                    break;
                case "center":
                    f.vertical.test(d[0]) ? n.left = m.left + m.width / 2 - h / 2 : n.top = m.top + m.height / 2 - i / 2
            }
            return n.top = Math.round(n.top), n.left = Math.round(n.left), n.placement = "center" === d[1] ? d[0] : d[0] + "-" + d[1], n
        },
        adjustTop: function(a, b, c, d) {
            if (a.indexOf("top") !== -1 && c !== d) return {
                top: b.top - d + "px"
            }
        },
        positionArrow: function(a, c) {
            ...
            if (g) {
                ...
                q += f.vertical.test(c[0]) ? c[0] + "-" + c[1] : c[1] + "-" + c[0], q += "-radius";
    ...
    this.init = function(e) {
        ...
        D = angular.element("<div uib-datepicker-popup-wrap data-ng-class=\"{'show': isOpen}\"><div uib-datepicker></div></div>"), D.attr({
            "ng-model": "date",
    ...
    var f = function(a) {
        if (d && d.isOpen && !(a && "disabled" === d.getAutoClose() || a && 3 === a.which)) {
            ...
            if (!(a && c && c[0].contains(a.target))) {
                ...
                a && "outsideClick" === d.getAutoClose() && e && e[0].contains(a.target) || (d.isOpen = !1, b.$$phase || d.$apply())
            }
        }
    };
    this.keybindFilter = function(a) {
        if (d) {
            ...
            27 === a.which ? (a.stopPropagation(), d.focusToggleElement(), f()) : d.isKeynavEnabled() && [38, 40].indexOf(a.which) !== -1 && d.isOpen && (e || g) && (a.preventDefault(), a.stopPropagation(), d.focusDropdownEntry(a.which))
        }
    }
    ...
    b.addClass("dropdown"), this.init = function() {
        ...
        var c = o.dropdownMenu ? angular.element(o.dropdownMenu).find(".dropdown-item") : b.find("div").eq(0).find("a.");
        switch (a) {
            case 40:
        ...
        var F = u ? u : angular.element(b[0].querySelector("[uib-dropdown-menu]")),
            G = u ? q : r,
            H = F.hasClass(G),
            I = f.isOnlyOpen(a, u);
        if (H === !e) {
            var J;
            J = u ? I ? "removeClass" : "addClass" : e ? "addClass" : "removeClass", g[J](b, G), g[J](F, G).then(function() {
        ...
        if (e) o.dropdownMenuTemplateUrl ? k(o.dropdownMenuTemplateUrl).then(function(a) {
            m = p.$new(), j(a.trim())(m, function(a) {
                var b = a;
                o.dropdownMenu.replaceWith(b), o.dropdownMenu = b, g.addClass(o.dropdownMenu, G), i.on("keydown", f.keybindFilter)
            })
    ...
    return {
        ...
        link: function(a, b, c, d) {
            if (d) {
                ...
                b.on("click", e);
                var f = function(e) {
                    40 !== e.which || d.isOpen() || (e.preventDefault(), e.stopPropagation(), b.hasClass("disabled") || c.disabled || a.$apply(function() {
                        d.toggle()
                    }))
                };
                b.on("keydown", f), b.attr({
                    "aria-haspopup": !0,
                    "aria-expanded": !1
...
}).directive("uibModalBackdrop", ["$uibModalStack", "$q", "$animate", function(a, b, c) {
    function d(d, e, f) {
        var g = b.defer();
        ...
        }), f.modalInClass && d.$on(a.NOW_CLOSING_EVENT, function(a, b) {
            var g = b();
            d.modalOptions.animation ? c.removeClass(e, f.modalInClass).then(g) : g()
        })
    }
    return {
        restrict: "A",
    ...
    return e.$watch(l, function(a) {
        ...
        o >= 0 && !t && (u = e.$new(!0), u.modalOptions = f, u.index = o, t = angular.element('<div uib-modal-backdrop="modal-backdrop"></div>'), t.attr({
            ...
            "modal-in-class": "show"
        }), f.backdropClass && t.addClass(f.backdropClass), f.animation && t.attr("modal-animation", "true"), a.enter(d(t)(u), m), v = i.scrollbarPadding(m), v.heightOverflow && v.scrollbarWidth && m.css({
        ...
        return h.on("keyup", n), k.$on("$destroy", function() {
            ...
            function(e, k, m, n) {
                ...
                var q = a(e),
                    r = j.startSymbol(),
                    s = j.endSymbol(),
                    t = "<div " + q + '-popup uib-title="' + r + "title" + s + '" ' + (n.useContentExp ? 'content-exp="contentExp()" ' : 'content="' + r + "content" + s + '" ') + 'origin-scope="origScope" class="uib-position-measure ' + k + '" tooltip-animation-class="fade"uib-tooltip-classes ng-class="{ show: isOpen }" ></div>';
                return {
                    compile: function(a, b) {
                        var c = f(t);
                        return function(a, b, d, f) {
                            ...
                            var E, F, G, H, I, J, K, L, M = !!angular.isDefined(n.appendToBody) && n.appendToBody,
                                N = p(void 0),
                                O = angular.isDefined(d[k + "Enable"]),
                                P = a.$new(!0),
                                Q = !1,
                                R = !!angular.isDefined(d[k + "IsOpen"]) && l(d[k + "IsOpen"]),
                                S = !!n.useContentExp && l(d[e]),
                                T = [],
                                U = function() {
                                    E && E.html() && (J || (J = g(function() {
                                        var a = i.parsePlacement(P.placement),
                                            c = "center" === a[1] ? a[0] : a[0] + "-" + a[1];
                                        E.hasClass(a[0]) || (E.removeClass(L.split("-")[0]), E.addClass(a[0])), E.hasClass(n.placementClassPrefix + c) || (E.removeClass(n.placementClassPrefix + L), E.addClass(n.placementClassPrefix + c));
                                        var d = i.positionElements(b, E, P.placement, M, !0),
                                            e = angular.isDefined(E.offsetHeight) ? E.offsetHeight : E.prop("offsetHeight"),
                                            f = M ? i.offset(b) : i.position(b);
                                        E.css({
                                            top: d.top + "px",
                                            left: d.left + "px"
                                        }), K = g(function() {
                                            var b = angular.isDefined(E.offsetHeight) ? E.offsetHeight : E.prop("offsetHeight"),
                                                c = i.adjustTop(a, f, e, b);
                                            c && E.css(c), K = null
                                        }, 0, !1), E.hasClass("uib-position-measure") ? (i.positionArrow(E, d.placement), E.removeClass("uib-position-measure")) : L !== d.placement && i.positionArrow(E, d.placement), L = d.placement, J = null
                                    }, 0, !1)))
                                };
                            ...
                            X = Y in d && void 0 === d[Y] || a.$eval(d[Y]), M = angular.isDefined(X) ? X : M, a.$on("$destroy", function() {
                                V(), w(), P = null
                            })
                        }
                    }
    ...
    function h() {
        ...
        if (c && "" !== a.hours) return a.showMeridian && (12 === b && (b = 0), a.meridian === y[1] && (b += 12)), b
    }
    ...
    c.secondStep && w.push(a.$parent.$watch(d(c.secondStep), function(a) {
        ...
        a.updateHours = function() {
            var a = h(),
                b = i();
            x.$setDirty(), angular.isDefined(a) && angular.isDefined(b) ? (v.setHours(a), v.setMinutes(b), v < C || v > D ? e(!0) : l("h")) : e(!0)
            ...
            var a = i(),
                b = h();
            x.$setDirty(), angular.isDefined(a) && angular.isDefined(b) ? (v.setHours(b), v.setMinutes(a), v < C || v > D ? e(void 0, !0) : l("m")) : e(void 0, !0)
        ...
        var b = x.$viewValue;
        isNaN(b) ? (x.$setValidity("time", !1), e.error('Timepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.')) : (b && (v = b), v < C || v > D ? (x.$setValidity("time", !1), a.invalidHours = !0, a.invalidMinutes = !0) : m(), n())
    ...
    var x, y, z = e(c.typeaheadLoading).assign || angular.noop,
        ...
        C = !!angular.isDefined(c.typeaheadSelectOnBlur) && a.$eval(c.typeaheadSelectOnBlur),
    ...
    P.$watch("activeIdx", function(a) {
        a < 0 ? b.removeAttr("aria-activedescendant") : b.attr("aria-activedescendant", X(a))
    });
    var Y = function(a, b) {
            return !!(P.matches.length > b && a) && a.toUpperCase() === P.matches[b].label.toUpperCase()
        },
        Z = function(c, d) {
            var e = {
                $viewValue: c
    ...
    W(), P.assignIsOpen = function(b) {
        ...
        if (0 !== P.matches.length && s.indexOf(b.which) !== -1) {
            ...
            if (P.activeIdx === -1 && c || 9 === b.which && b.shiftKey) return W(), void P.$digest();
            b.preventDefault();
            var d;
            switch (b.which) {
                case 27:
        ...
        C && P.matches.length && P.activeIdx !== -1 && !y && (y = !0, P.$apply(function() {
    ...
    a.put("uib/template/accordion/accordion-group.html", '<div role="tab" id="{{::headingId}}" aria-selected="{{isOpen}}" class="card-header" ng-keypress="toggleOpen($event)">\n  <h5 class="mb-0">\n    <a role="button" data-toggle="collapse" href aria-expanded="{{isOpen}}" aria-controls="{{::cardId}}" tabindex="0" class="accordion-toggle"  ng-click="toggleOpen()" uib-accordion-transclude="heading" ng-disabled="isDisabled" uib-tabindex-toggle><span uib-accordion-header ng-class="{\'text-muted\': isDisabled}">{{heading}}</span></a>\n  </h5>\n</div>\n<div id="{{::cardId}}" aria-labelledby="{{::headingId}}" aria-hidden="{{!isOpen}}" role="tabcard" class="card-collapse collapse" uib-collapse="!isOpen">\n  <div class="card-body" ng-transclude></div>\n</div>\n')
}]), angular.module("uib/template/accordion/accordion.html", []).run(["$templateCache", function(a) {
    a.put("uib/template/accordion/accordion.html", '<div role="tablist" ng-transclude></div>\n')
    ...
    a.put("uib/template/progressbar/bar.html", '<div class="progress-bar" ng-class="[type ? \'bg-\' + type : \'\', striped ? \'progress-bar-striped\' : \'\']" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="{{max}}" ng-style="{width: (percent < 100 ? percent : 100) + \'%\'}" aria-valuetext="{{percent | number:0}}%" aria-labelledby="{{::title}}" ng-transclude></div>\n')
    ...
    a.put("uib/template/tabs/tab.html", '<li class="uib-tab nav-item">\n  <a href ng-click="select($event)" ng-class="[{active: active, disabled: disabled}, classes]" class="nav-link" uib-tab-heading-transclude>{{heading}}</a>\n</li>\n')
    ...
    !angular.$$csp().noInlineStyle && !angular.$$uibCommonCss && angular.element(document).find("head").prepend('<style type="text/css">.fa-svg-icon{display:inline-block;vertical-align:middle;min-width:1em;min-height:1em;height:100%;position:relative;top:-1px;}.fa-svg-icon svg{position:absolute;top:0;left:0;width:100%;height:100%;}.fa-svg-icon svg g,.fa-svg-icon svg path{fill:currentColor;}</style>'), angular.$$uibCommonCss = !0
    ...
    !angular.$$csp().noInlineStyle && !angular.$$uibTimepickerCss && angular.element(document).find("head").prepend('<style type="text/css">.uib-time input{width:50px !important;}</style>'), angular.$$uibTimepickerCss = !0
