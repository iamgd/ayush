...
<body>
    <div class="container">
        ...
        <div class="row">
			...
			<a href="index.html" style="text-decoration: none; color: black;"><i class="fa fa-arrow-left"></i> Back</a>
    ...
    <img style="margin-top:10px;" src="./images/moaemblem.jpg" width="230" height="80" alt="AYUSH">
                ...
                <form action="login.php" method="POST">
                    ...
                    <div id="error" class="text-center" style="color:red;"><?php echo $message;?></div>
					<br/>
